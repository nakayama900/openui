...
If you're building a framework-specific app, use `@openuidev/react-lang`, `@openuidev/vue-lang` or `@openuidev/svelte-lang`. For ArrowJS (or other custom renderers), build directly on `@openuidev/lang-core`.
